//
//  FourOptionCardTableViewCell.swift
//  alt
//
...
class FourOptionCardTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var dOptionValue: UILabel!
    ...
    func setFourOptionCell(question:String, options:Array<String>, results:Array<Int>, userAnswered:Bool){
        ...
        if userAnswered {
            ...
            dOptionLabel.textColor = UIColor.colorFromRGB(rgb: (indexOfMaxValue == 3 ? "393939":"13A7A1"), alpha: 1.0)
            dOptionValue.textColor = UIColor.colorFromRGB(rgb: (indexOfMaxValue == 3 ? "393939":"13A7A1"), alpha: 1.0)
            ...
            dOptionLabel.textColor = UIColor.colorFromRGB(rgb: "13A7A1", alpha: 1.0)
            aOptionValue.isHidden = true
            bOptionValue.isHidden = true
            cOptionValue.isHidden = true
            dOptionValue.isHidden = true
        }
